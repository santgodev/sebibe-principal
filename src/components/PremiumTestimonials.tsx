...
const testimonials = [
    {
        ...
        age: "19 años",
        image: "/assets/images/students/juan-h.png",
    ...
    },
    {
        ...
        age: "58 años",
        image: "/assets/images/students/alveiro-m.png",
    ...
    },
    {
        ...
        age: "18 años",
        image: "/assets/images/students/sara-g.png",
    ...
    },
    {
        ...
        age: "33 años",
        image: "/assets/images/students/brayan-r.png",
    ...
    },
    {
        ...
        age: "30 años",
        image: "/assets/images/students/nataly-v.png",
    ...
    },
    {
        ...
        age: "18 años",
        image: "/assets/images/students/kevin.png",
    ...
    },
    {
        ...
        age: "22 años",
        image: "/assets/images/students/eric-j.png",
    ...
    },
    {
        ...
        age: "17 años",
        image: "/assets/images/students/samuel-d.png",
    ...
    },
    {
        ...
        age: "21 años",
        image: "/assets/images/students/santiago-g.png",
    ...
    },
    {
        ...
        age: "18 años",
        image: "/assets/images/students/vanessa.png",
    ...
    },
    {
        ...
        age: "20 años",
        image: "/assets/images/students/estefany.png",
    ...
    },
    {
        ...
        age: "18 años",
        image: "/assets/images/students/jaifer-m.png",
    ...
    },
    {
        ...
        age: "18 años",
        image: "/assets/images/students/edaifer-m.png",
    ...
    },
    {
        ...
        age: "17 años",
        image: "/assets/images/students/juan-jose.png",
    ...
    },
    {
        ...
        age: "24 años",
        image: "/assets/images/students/osting.png",
    ...
    },
    {
        ...
        age: "19 años",
        image: "/assets/images/students/esteban.png",
...
export default function PremiumTestimonials() {
    ...
    const openDonationModal = (e: React.MouseEvent, name?: string) => {
        e.stopPropagation();
    ...
    return (
        <section className={styles.pageWrapper}>
            ...
            <div className={styles.header}>
                ...
                <button
                    className={styles.mainSupportBtn}
                    onClick={(e) => openDonationModal(e)}
                >
                    <svg className={styles.heartIcon} viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                    ...
                    >
                        ...
                        <div className={styles.contentBox}>
                            <div className={styles.contentScroll}>
                                ...
                                <button
                                    className={styles.supportStudentBtn}
                                    onClick={(e) => openDonationModal(e, item.name)}
                                >
            ...
            {showDonationModal && (
                <div className={styles.modalOverlay} onClick={() => setShowDonationModal(false)}>
                    <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
                        <button className={styles.closeModal} onClick={() => setShowDonationModal(false)} aria-label="Close">
                        ...
                        <div className={styles.modalHeader}>
                            <h2 className={styles.modalTitle}>
                                {selectedStudentName ? `${t("apoyar_estudiante")} - ${selectedStudentName}` : t("apoyar_estudiante")}
                            </h2>
                            <p className={styles.modalSubtitle}>{t("metodo_pago")}</p>
                        </div>

                        <div className={styles.qrGrid}>
                            <div className={styles.qrItem}>
                                <div className={styles.qrCard}>
                                    <Image src="/assets/images/qr/nequi.png" alt="QR Nequi" width={300} height={300} className={styles.qrImage} />
                                    <span className={styles.qrLabel}>Nequi</span>
                                </div>
                            </div>
                            <div className={styles.qrItem}>
                                <div className={styles.qrCard}>
                                    <Image src="/assets/images/qr/bancolombia.png" alt="QR Bancolombia" width={300} height={300} className={styles.qrImage} />
                                    <span className={styles.qrLabel}>Bancolombia</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={styles.whatsappSection}>
                            ...
                            <p className={styles.instructionText}>{t("instruccion_comprobante")}</p>
                            <a
                                href={`https://wa.me/573144787072?text=${encodeURIComponent(
                                    selectedStudentName
                                        ? `Hola, acabo de realizar un apoyo para el estudiante ${selectedStudentName}. Aquí envío el comprobante por control financiero.`
                                        : "Hola, acabo de realizar un apoyo para los estudiantes del SEBIBE. Aquí envío el comprobante por control financiero."
                                )}`}
                                target="_blank"
